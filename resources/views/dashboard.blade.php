...
<!-- Responsive Table -->
<div class="card" id="track-status-content" style="display:none;" style="margin: 15px; border-radius: 30px;">
...
<script>
    function showTrackStatus() {
        ...
        document.getElementById('track-status-content').style.display = 'block';

        // Highlight active menu item
        document.querySelectorAll('.menu-item').forEach(i => i.classList.remove('active'));
        document.getElementById('menu-track-status').classList.add('active');
    }

    function showDashboard() {
        document.getElementById('track-status-content').style.display = 'none';
