...
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://www.ttunikit.co.za/assets/img/homeslider/THE BEST ICT COMPANY IN TOWN(9).png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="https://www.ttunikit.co.za/assets/img/homeslider/THE BEST ICT COMPANY IN TOWN(12).png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="https://www.ttunikit.co.za/assets/img/homeslider/THE BEST ICT COMPANY IN TOWN(11).png" class="d-block w-100" alt="...">
    </div>
  </div>
